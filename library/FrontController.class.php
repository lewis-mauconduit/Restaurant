...
class FrontController
{
    ...
    public function __construct()
    {
        ...
        [
            ...
            'variables' =>
            [
                'requestUrl' => $_SERVER['SCRIPT_NAME'], // $requestUrl/......Pour localiser sa page
                'wwwUrl'     => str_replace('index.php', 'application/www', $_SERVER['SCRIPT_NAME']) // $wwwUrl/....Pour localiser ses assets
            ]
        ];
    }
